...
start "" ffmpeg -i "rtsp://192.168.100.24:8080/h264.sdp" -c:v copy -an -f hls -hls_time 2 -hls_list_size 5 -hls_flags delete_segments+append_list "C:\xampp\htdocs\CC106\hls\stream.m3u8"

:: Start FFmpeg for Camera 2
start "" ffmpeg -i "rtsp://192.168.100.18:8080/h264.sdp" -c:v copy -an -f hls -hls_time 2 -hls_list_size 5 -hls_flags delete_segments+append_list "C:\xampp\htdocs\CC106\hls2\stream2.m3u8"
