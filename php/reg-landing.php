...
<head>
    ...
    <link rel="stylesheet" href="/cc106/css/styles.css">
...
<div class="content">
            ...
            <h1>Start your security with <span class="element"></span>!</h1>
                ...
                <button class="register-btn" onclick="window.location.href='/cc106/php/reg-registration.php';">Register</button>
            </div>
        </div>    
        <img src="/cc106/images/svg_bottom.png" alt="" style="width: 100%;position: fixed;bottom: 0;left: 0;height: 150px;">
